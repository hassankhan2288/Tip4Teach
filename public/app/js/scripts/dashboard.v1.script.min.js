...
$(document).ready(function () {
  ...
  if (echartElemBar) {
    ...
    echartBar.setOption({
      ...
      yAxis: [{
        ...
        min: reports.min_amount,
        max: reports.max_amount,
        // interval: 250000,
        axisLine: {
          show: false
        },
  ...
  var echartElemBarMonth = document.getElementById('echartBarMonth');

  if (echartElemBarMonth) {
    var echartBarMonth = echarts.init(echartElemBarMonth);
    echartBarMonth.setOption({
      legend: {
        borderRadius: 0,
        orient: 'horizontal',
        x: 'right',
      ...
      yAxis: [{
        ...
        min: current_month_sale1.min_amount,
        max: current_month_sale1.max_amount,
        // min: 10,
        // max: 10000,
      ...
      series: [{
        name: 'Sale',
        data:  current_month_sale1.TotalSales,
        label: {
          show: false,
          color: '#0168c1'
        },
    ...
    $(window).on('resize', function () {
      setTimeout(function () {
        echartBarMonth.resize();
      }, 500);
    });
  }
  var echartElemBar = document.getElementById('companyEchartBar');

  if (echartElemBar) {
    var companyEchartBar = echarts.init(echartElemBar);
    companyEchartBar.setOption({
      legend: {
        borderRadius: 0,
        orient: 'horizontal',
        x: 'right',
  ...
  if (echartElemPie) {
    ...
    echartPie.setOption({
      color: ['#008000', '#008000', '#008000', '#008000', '#008000', '#008000'],
      tooltip: {
        show: true,
        backgroundColor: 'rgba(0, 0, 0, .8)'
      },
