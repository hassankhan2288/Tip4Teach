...
@section('content')
    ...
    <div class="earnings d-flex align-items-center">
        ...
        <svg class="progres" width="100" height="100">
            <circle class="progress-circle" cx="40" cy="40" r="30" fill="#E2FBD7" stroke="#34B53A"
                stroke-width="3"></circle>
            <text class="loading" fill="#282B29" x="40" y="45" text-anchor="middle" align-baseline="middle"
                data-prog="96"></text>
        </svg>
            ...
            <div class="col-12 col-xxl-4 dash-cards">
                <div class="balance mb-3 position-relative text-center ">
                    <div class="d-flex align-items-center justify-content-between balance-header">
                        <div>
                            <span class="icon"><img src="{{ asset('frontend/img/vaadin_wallet.svg') }}"
                                    alt="vaadin_wallet"></span>
                            <span>Total Balance</span>
                        </div>
                        <div class="dropdown">
                            <button class="dropdown-toggle balance-drop-btn border-0 " type="button"
                    ...
                    <img src="{{ asset('frontend/img/Rectangle 93 (1).svg') }}" class="position-absolute balance-img"
                        alt="balance">
                </div>
