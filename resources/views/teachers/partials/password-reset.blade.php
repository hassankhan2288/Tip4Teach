    ...
    <div class="container">
        <div class="row d-flex justify-content-center ">
            ...
            <div class="col-lg-6 col-12">
                <form method="POST" action="{{ route('teacher.password.update') }}" class="profile-form">
                  @csrf
      ...
      <div class="container">
          <div class="tch-contact-popup text-center">
            <div class="img-container mb-3">
              ...
              <div class="banner">
                  <a href="teacher-dashboard.html" class="log-btn butn butn__new"><span>Back to dashboard</span></a>
              </div>
          </div>
      </div>
  </div>
