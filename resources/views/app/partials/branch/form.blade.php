             ...
             <form method="post" action="{{route('app.branch.submit')}}">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    <label for="assign_branch_no">Branch No</label>
                    <input id="assign_branch_no" type="text" class="form-control @error('assign_branch_no') is-invalid @enderror" name="assign_branch_no" value="{{old("assign_branch_no")??$admin->assign_branch_no??""}}" autocomplete="assign_branch_no" autofocus>

                    @error('assign_branch_no')
