...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="{{ route('app.branch') }}" class="card card-icon-bg card-icon-bg-primary o-hidden mb-4" style="border: 1px solid #008000; border-radius: 0.25rem;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="{{ route('app.report') }}" class="card card-icon-bg card-icon-bg-primary o-hidden mb-4" style="border: 1px solid #008000; border-radius: 0.25rem;">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
            <a href="{{ route('app.product') }}" class="card card-icon-bg card-icon-bg-primary o-hidden mb-4" style="border: 1px solid #008000; border-radius: 0.25rem;">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="row">
                <div class="col-lg-4 col-md-12">
                    <div class="card card-chart-bottom o-hidden mb-4" style="border: 1px solid #008000; border-radius: 0.25rem;">
                        <div class="card-body">
                            <div class="text-muted">Last Month Sales</div>
                            <p class="mb-4 text-warning text-24">£{{ $last_month_sale ?? 0 }}</p>
                        </div>
