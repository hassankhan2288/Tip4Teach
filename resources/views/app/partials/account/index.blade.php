                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('account.save.settings') }}" id="account-settings">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="shop-url">Contact Person</label>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="shop-url">Phone Number</label>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="shop-url">Email Address</label>
