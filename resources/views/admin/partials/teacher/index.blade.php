    ...
    <section id="pricing" class="pricing">
        ...
        <div class="row mb-4">
            <div class="col-md-12 mb-4">
                <a class="btn btn-primary ladda-button float-right" href="{{ route('admin.teacher.form') }}"
                    data-style="expand-left">Add</a>
            </div>
                    ...
                    name: 'last_name'},
                {
                    ...
                    name: 'email' },
                    {
                        ...
                        render: function(data) {
                            return data == 1 ? 'Current Teacher' : 'Former Teacher';
                        }
                    },
                {
                    data: 'is_active',
